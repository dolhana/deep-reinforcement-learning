...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=64, fc2_units=64, device=device):
        """DQN agent
...
class ReplayBuffer:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed, device=device):
        """A ReplayBuffer
